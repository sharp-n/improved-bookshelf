...
public class WebAppService {
    ...
    public String genTableOfSortedItemsFromFiles(ParametersForWeb param, String sortingParam) {
    ...
    public String genTableOfSortedItemsFromFiles(ParametersForWeb param) {
        ProjectHandler projectHandler = genProjectHandlerFromParameters(param);
    ...
    public List<List<String>> getAllTheItemsAsStringListSortedByComparator(ItemHandler itemHandler, Librarian librarian) {
    ...
    public List<List<String>> getItemsAsStringListSortedByComparator(ItemHandler itemHandler, Librarian librarian, String comparator) {
