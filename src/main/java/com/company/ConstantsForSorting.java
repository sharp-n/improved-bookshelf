...
public class ConstantsForSorting {
    ...
    public static final Comparator<Book> COMPARATOR_ITEM_BY_DATE = Comparator.comparing(Book::getPublishingDate);
    public static final Comparator<Book> COMPARATOR_ITEM_BY_AUTHOR = Comparator.comparing(Book::getAuthor);
